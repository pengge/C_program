// MessageReceiveSampleDlg.cpp : implementation file
//

#include "stdafx.h"
#include "MessageReceiveSample.h"
#include "MessageReceiveSampleDlg.h"
...
CMessageReceiveSampleDlg::CMessageReceiveSampleDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CMessageReceiveSampleDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CMessageReceiveSampleDlg)
	m_Log = _T("");
	//}}AFX_DATA_INIT
...
void CMessageReceiveSampleDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CMessageReceiveSampleDlg)
	DDX_Control(pDX, IDC_EDIT_LOG, m_editLog);
	DDX_Text(pDX, IDC_EDIT_LOG, m_Log);
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CMessageReceiveSampleDlg, CDialog)
	//{{AFX_MSG_MAP(CMessageReceiveSampleDlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_WM_COPYDATA()
...
/////////////////////////////////////////////////////////////////////////////
// CMessageReceiveSampleDlg message handlers
...
void CMessageReceiveSampleDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CMessageReceiveSampleDlg::OnPaint() 
{
	if (IsIconic())
	{
...
HCURSOR CMessageReceiveSampleDlg::OnQueryDragIcon()
{
...
// 记录日志
void CMessageReceiveSampleDlg::WriteLog(LPCTSTR format,...)	// 记录日志
{
