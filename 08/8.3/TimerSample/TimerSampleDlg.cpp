// TimerSampleDlg.cpp : implementation file
//
...
CTimerSampleDlg::CTimerSampleDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CTimerSampleDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CTimerSampleDlg)
	m_StaticTime = _T("");
	//}}AFX_DATA_INIT
...
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CTimerSampleDlg)
	DDX_Text(pDX, IDC_STATIC_TIME, m_StaticTime);
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CTimerSampleDlg, CDialog)
	//{{AFX_MSG_MAP(CTimerSampleDlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
/////////////////////////////////////////////////////////////////////////////
// CTimerSampleDlg message handlers
...
void CTimerSampleDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CTimerSampleDlg::OnTimer(UINT nIDEvent) 
{
	...
	CString log;
	log.Format("%d", m_Span.GetSeconds());
	m_StaticTime = log;
	UpdateData(FALSE);
